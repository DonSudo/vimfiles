...
let plugin_dir = vimfiles . '/pluggged'
...
" diff cursor style in diff mode
" TODO
...
let g:startify_custom_header =
             \ startify#pad(readfile(vimfiles.'/vim_header.txt'))
...
" coc-config
let g:coc_global_extensions = ['coc-vimlsp', 'coc-json', 'coc-clangd', 'coc-sh', 'coc-explorer', 'coc-pyright', 'coc-translator', 'coc-snippets', 'coc-pairs', 'coc-yank', 'coc-tabnine']
